...
We also evaluate six additional architectures---CNN, Residual CNN, Gohr-MLP (larger), LSTM, GRU, and Siamese---on \speck at 5 rounds, as well as Gohr's depth-10 ResNet on all three ciphers (\Cref{sec:exp-ablation}).
