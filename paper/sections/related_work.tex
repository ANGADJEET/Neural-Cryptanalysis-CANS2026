...
None studies cross-family transfer under controlled conditions.
We fill this gap with a benchmark that holds architecture, data volume, input representation, and training protocol constant while varying only the cipher and round count.
