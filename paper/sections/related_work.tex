...
None jointly addresses where the distinguishing signal resides in ciphertext data and whether that signal composes across rounds in a Markovian fashion.
